  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative w-full h-[300px] md:h-[500px] flex items-center justify-center py-10"
      >
        <div className="relative w-full max-w-7xl h-full flex items-center justify-center">
          {/* Left Phone */}
          <div
            ref={leftPhoneRef}
            className="absolute z-10 w-[28%] max-w-[160px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-[220px] xl:max-w-[240px] 2xl:max-w-[260px]"
            style={{
              top: "50%",
              left: "30%",
          ...
          <div
            ref={centerPhoneRef}
            className="absolute z-20 w-[32%] max-w-[180px] sm:max-w-[220px] md:max-w-[260px] lg:max-w-[260px] xl:max-w-[300px] 2xl:max-w-[320px]"
            style={{
              top: "50%",
              left: "50%",
              transform: "translate(-50%, -50%)",
