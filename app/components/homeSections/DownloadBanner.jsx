...
export default function DownloadBanner() {
    return (
        <div className="w-full px-4 md:px-0 bg-white candySection ">
            <div className="container relative w-full mx-auto rounded-xl overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-12 gap-8"
                style={{
                    background:
            ...
            >
                ...
                <div className="relative z-10 flex-shrink-0">
                    <PlayNowButton>Download Now</PlayNowButton>
                </div>
            </div>
            <Image src={cCrush} alt="cCrush" height={400} className=" py-20 "/ >
        </div>
    );
};